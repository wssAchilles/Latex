...
\fancypagestyle{plain}{%
  \fancyhf{} 
  \lhead{\includegraphics[height=1cm]{figures/logo-black.png}}
...
\mainmatter
\input{mainmatter/database}
\input{mainmatter/lstm&else}
\input{mainmatter/introduction}
\input{mainmatter/Food security problem}
\input{mainmatter/technology}
\input{mainmatter/basic}
\input{mainmatter/famer}
\input{mainmatter/people}
