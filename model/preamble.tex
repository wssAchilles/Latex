...
\lstset{
    ...
    literate=*{∈}{{\ensuremath{\in}}}1 {⊕}{{\ensuremath{\oplus}}}1 {Δ}{{\ensuremath{\Delta}}}1 {Σ}{{\ensuremath{\Sigma}}}1 {≤}{{\ensuremath{\le}}}1 {≥}{{\ensuremath{\ge}}}1 {–}{{-}}1 {—}{{-}}1
}

% 为附录代码定义更具可读性的彩色样式（不改动全局默认）
\definecolor{pyKeyword}{RGB}{0,92,184}
\definecolor{pyString}{RGB}{196,26,22}
\definecolor{pyComment}{RGB}{0,120,0}
\definecolor{pyEmph}{RGB}{180,0,90}
...
\lstdefinestyle{appendixpy}{
    ...
    stringstyle=\color{pyString}\ttfamily,
    emph={pca_lhs_samples,empirical_cvar,evaluate_decisions,simple_rolling_demo},
    emphstyle=\color{pyEmph}\bfseries,
    showstringspaces=false, breaklines=true, breakatwhitespace=false,
    breakautoindent=true, breakindent=1em,
    prebreak=\mbox{\tiny$\hookleftarrow$}, postbreak=\mbox{\tiny$\rightarrow$\,},
    frame=single, framerule=0.4pt, rulecolor=\color{gray},
    numbers=none, captionpos=b,
    xleftmargin=0em, xrightmargin=0em,
    aboveskip=0pt, belowskip=0pt,
    tabsize=4, keepspaces=true, columns=fullflexible,
    basewidth=0.52em,
...
%======================================================================
\title{\heiti \zihao{2} \bfseries 农作物种植策略的优化决策模型——基于鲁棒优化与动态调整的综合方法}
\author{}
\date{}