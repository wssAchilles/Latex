...
%	pdfstandard = a-2b,
	pdfstandard = ua-2,
	pdfversion  = 2.0,
	testphase	= {phase-III,table,math,title,firstaid},
%	debug		= {xmp-export}, % note that subject entries are all fine in dc format of outputted xmpi file.
}

%%%%%%%%%  Documentclass and options  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\documentclass[fontset=heros-stix2,mydesign=mydesign_redsans_headings]{mitthesis}% fontset=libertinus, fontset=lmodern, fontset=lucida, 
